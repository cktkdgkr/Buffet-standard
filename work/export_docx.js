...
children.push(para("주주이익 기준 2단계 DCF입니다. 보수 시나리오는 할인율 12%·영구성장 2.0%, 기준은 10%·2.5%, 낙관은 8%·3.0%이며 예측기간은 10년입니다. 금액 단위는 십억 달러이고, P/적정가치가 1.0보다 크면 시장이 이 DCF보다 비싸게 매기고 있다는 뜻입니다.",
  { run: { size: 20 } }));
children.push(table(
  ["티커", "기업", "주주이익", "시가총액", "보수", "기준", "낙관", "P/적정가치", "안전마진", "판정"],
  payload.valuation_rows,
  [900, 2800, 1400, 1400, 1400, 1400, 1400, 1200, 1300, 1200],
...
// ---------------------------------------------------------------- limits
children.push(new Paragraph({ children: [], pageBreakBefore: true }));
children.push(h1("7. 한계와 데이터 처리 원칙"));
